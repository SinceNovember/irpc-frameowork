...
import com.simple.irpc.framework.core.proxy.javassist.JavassistProxyFactory;
import com.simple.irpc.framework.core.proxy.jdk.JDKProxyFactory;
...
public class Client {
    ...
    public static void setClientGroup(EventLoopGroup clientGroup) {
    ...
    public void doSubscribeService(Class serviceBean) {
        if (ABSTRACT_REGISTER == null) {
            try {
                ...
                Class<AbstractRegister> registerClass = registerMap.get(clientConfig.getRegisterType());
                ABSTRACT_REGISTER = registerClass.newInstance();
            }catch (Exception e) {
